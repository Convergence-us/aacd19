   ...
   // private storage: SQLite;
	...
	public getLecturesByDay(dayID, listingType, AttendeeID) {
		...
		if (this.DevicePlatform == "iOS" || this.DevicePlatform == "Android") {
			...
			switch (selectedDate) {
				case "6/1/2019":
					SQLquery = SQLquery + "WHERE c.session_start_time LIKE '2019-06-01%' ";
					break;
				case "6/2/2019":
					SQLquery = SQLquery + "WHERE c.session_start_time LIKE '2019-06-02%' ";
					break;
				case "6/3/2019":
					SQLquery = SQLquery + "WHERE c.session_start_time LIKE '2019-06-03%' ";
					break;
				case "6/4/2019":
					SQLquery = SQLquery + "WHERE c.session_start_time LIKE '2019-06-04%' ";
					break;
				case "6/5/2019":
					SQLquery = SQLquery + "WHERE c.session_start_time LIKE '2019-06-05%' ";
					break;
				default:
					SQLquery = SQLquery + "WHERE c.session_start_time LIKE '2019-06-01%' ";
					break;
