...
var SyncURLReference: string = "https://naeyc.convergence-us.com/cvPlanner.php?acy=PLI2019&";
						...
						for (var i = 0; i < data['length']; i++) {
							...
							switch(data[i].TableName) {
								...
								case "itinerary":
									...
									SQLQueryDelete = "NO";
									break;
								case "courses_handouts":
									SQLQuerySelect = "SELECT handoutID FROM courses_handouts WHERE handoutID = '" + data[i].handoutID + "'";

									SQLQueryInsert = "INSERT INTO courses_handouts(";
									SQLQueryInsert = SQLQueryInsert + "handoutID, session_id, handoutTitle, handoutFilename, ActiveYN) ";
									SQLQueryInsert = SQLQueryInsert + "VALUES(" + data[i].handoutID + ", ";
									SQLQueryInsert = SQLQueryInsert + "'" + data[i].session_id + "', ";
									SQLQueryInsert = SQLQueryInsert + "'" + data[i].handoutTitle + "', ";
									SQLQueryInsert = SQLQueryInsert + "'" + data[i].handoutFilename + "', ";
									SQLQueryInsert = SQLQueryInsert + "'" + data[i].ActiveYN + "')";

									SQLQueryUpdate = "UPDATE courses_handouts ";
									SQLQueryUpdate = SQLQueryUpdate + "SET session_id = '" + data[i].session_id + "', ";
									SQLQueryUpdate = SQLQueryUpdate + "handoutTitle = '" + data[i].handoutTitle + "', ";
									SQLQueryUpdate = SQLQueryUpdate + "handoutFilename = '" + data[i].handoutFilename + "', ";
									SQLQueryUpdate = SQLQueryUpdate + "ActiveYN = '" + data[i].ActiveYN + "' ";
									SQLQueryUpdate = SQLQueryUpdate + "WHERE handoutID = '" + data[i].handoutID + "' ";
									
									SQLQueryDelete = "NO";
									//SQLQueryDelete = "DELETE FROM courses_handouts ";
								...
								case "courses_speakers_ordering_remove":
									...
									SQLQueryUpdate = "DELETE FROM courses_speakers_ordering ";
									SQLQueryUpdate = SQLQueryUpdate + "WHERE speakerID = " + data[i].speakerID + " ";
									SQLQueryUpdate = SQLQueryUpdate + "AND session_id = '" + data[i].session_id + "'";
								...
								case "lookup_rooms":
									...
									SQLQueryInsert = SQLQueryInsert + "lrID, RoomName, FloorNumber, ";
									SQLQueryInsert = SQLQueryInsert + "BuildingName, RoomX, RoomY, ActiveYN, DateAdded) ";
								...
								case "notifications":
									...
									SQLQueryUpdate = "UPDATE attendee_push_notifications ";
									SQLQueryUpdate = SQLQueryUpdate + "SET pushTitle = '" + data[i].pushTitle + "', ";
									SQLQueryUpdate = SQLQueryUpdate + "pushMessage = '" + data[i].pushMessage + "', ";
									SQLQueryUpdate = SQLQueryUpdate + "pushDateTimeReceived = '" + data[i].pushDateTimeReceived + "' ";
									SQLQueryUpdate = SQLQueryUpdate + "WHERE pnID = '" + data[i].pnID + "' ";
