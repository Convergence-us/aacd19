...
import { NavController, Platform, AlertController, IonicModule, MenuController  } from '@ionic/angular';
...
/*
		...
		this.pages = [
		  ...
		  { title: 'Long Beach', icon: 'compass', component: ConferenceCityPage, naventry: 'ConferenceCity' },
...
/*
	...
	initializeApp() {
	 ...
	 this.statusBar.backgroundColorByHexString('#425195');
